...
function run(jsonObj) {
    ...
    // test
    document.write("In HERE! with shots: " + jsonObj[1].shots);

    var i;

    // dessa behåller vi ifall vi vill spara allmänna statistik utöver beräkningarna
    enemies.push(tmpenemy0(jsonObj));
